		...
		<ul className="grid grid-cols-5 grid-rows-2 gap-2 justify-items-center items-stretch mb-20">
			...
			<li className='p-2 w-full border border-gray-300/0 hover:shadow-lg hover:border-gray-200 hover:scale-105 duration-200'>
				<a className='flex flex-col' href="#">
					...
					<p className="mt-2.5 text-sm text-[#6c4f2c]">
						3,850 円 <span className="small">(税込)</span>
					</p>
				</a>
			</li>
			...
			<li className='p-2 w-full border border-gray-300/0 hover:shadow-lg hover:border-gray-200 hover:scale-105 duration-200'>
				<a className='flex flex-col' href="#">
					...
					<p className="mt-2.5 text-sm text-[#6c4f2c]">
						1,320 円 <span className="small">(税込)</span>
					</p>
				</a>
			</li>
			...
			<li className='p-2 w-full border border-gray-300/0 hover:shadow-lg hover:border-gray-200 hover:scale-105 duration-200'>
				<a className='flex flex-col' href="#">
					...
					<p className="mt-2.5 text-sm text-[#6c4f2c]">
						2,750 円 <span className="small">(税込)</span>
					</p>
				</a>
			</li>
			...
			<li className='p-2 w-full border border-gray-300/0 hover:shadow-lg hover:border-gray-200 hover:scale-105 duration-200'>
				<a className='flex flex-col' href="#">
					...
					<p className="mt-2.5">
						【Donguri Closet限定】ピンズコレクション わたしのお気に入り ※BOX販売※
					</p>
					<p className="mt-2.5 text-sm text-[#6c4f2c]">
						7,040 円 <span className="small">(税込)</span>
					</p>
				</a>
			</li>
			...
			<li className='p-2 w-full border border-gray-300/0 hover:shadow-lg hover:border-gray-200 hover:scale-105 duration-200'>
				<a className='flex flex-col' href="#">
					...
					<p className="mt-2.5">
						となりのトトロ シュパット コンパクトバッグ M 野原でかくれんぼ
					</p>
					<p className="mt-2.5 text-sm text-[#6c4f2c]">
						3,080 円 <span className="small">(税込)</span>
					</p>
				</a>
			</li>
			...
			<li className='p-2 w-full border border-gray-300/0 hover:shadow-lg hover:border-gray-200 hover:scale-105 duration-200'>
				<a className='flex flex-col' href="#">
					...
					<p className="mt-2.5 text-sm text-[#6c4f2c]">
						9,680 円 <span className="small">(税込)</span>
					</p>
				</a>
			</li>
			...
			<li className='p-2 w-full border border-gray-300/0 hover:shadow-lg hover:border-gray-200 hover:scale-105 duration-200'>
				<a className='flex flex-col' href="#">
					...
					<p className="mt-2.5 text-sm text-[#6c4f2c]">
					13,200
						円 <span className="small">(税込)</span>
					</p>
				</a>
			</li>
			...
			<li className='p-2 w-full border border-gray-300/0 hover:shadow-lg hover:border-gray-200 hover:scale-105 duration-200'>
				<a className='flex flex-col' href="#">
					...
					<p className="mt-2.5">
						【Donguri Closet限定】魔女の宅急便 フラワーブーケシリーズ グラス
					</p>
					<p className="mt-2.5 text-sm text-[#6c4f2c]">
						1,540 円 <span className="small">(税込)</span>
					</p>
				</a>
			</li>
			...
			<li className='p-2 w-full border border-gray-300/0 hover:shadow-lg hover:border-gray-200 hover:scale-105 duration-200'>
				<a className='flex flex-col' href="#">
					...
					<p className="mt-2.5">
						【そらのうえ店限定】となりのトトロ マックロクロスケの熊野筆
					</p>
					<p className="mt-2.5 text-sm text-[#6c4f2c]">
						8,800 円 <span className="small">(税込)</span>
					</p>
				</a>
			</li>
		</ul>
